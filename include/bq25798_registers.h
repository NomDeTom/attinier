...
//   Reset by: REG_RST
//
/** @brief Convert millivolts to VSYSMIN register value (bits 5:0 of REG00). Range 2500–16000 mV,
 * step 250 mV. */
 ...
 * @note BQ25798_REG_TEMPERATURE_CONTROL (0x16), bits 7:6. POR: 120°C (3h). Reset by
 * WATCHDOG/REG_RST.
 */
typedef enum {
 ...
 * @note BQ25798_REG_TEMPERATURE_CONTROL (0x16), bits 5:4. POR: 150°C (0h). Reset by
 * WATCHDOG/REG_RST.
 */
typedef enum {
...
/** @brief Enable VBUS pull-down resistor (6 kΩ) — bit 3 of BQ25798_REG_TEMPERATURE_CONTROL (0x16).
 * POR: disabled. */
#define BQ25798_VBUS_PD_EN_BIT (1u << 3)
/** @brief Enable VAC1 pull-down resistor — bit 2 of BQ25798_REG_TEMPERATURE_CONTROL (0x16). POR:
 * disabled. */
#define BQ25798_VAC1_PD_EN_BIT (1u << 2)
/** @brief Enable VAC2 pull-down resistor — bit 1 of BQ25798_REG_TEMPERATURE_CONTROL (0x16). POR:
 * disabled. */
#define BQ25798_VAC2_PD_EN_BIT (1u << 1)
/** @brief Turn on ACFET1 in backup mode (clears EN_BACKUP, sets EN_ACDRV1) — bit 0 of
 * BQ25798_REG_TEMPERATURE_CONTROL (0x16). POR: idle. */
 ...
 * @note BQ25798_REG_NTC_CONTROL_0 (0x17), bits 7:5. POR: VREG-400mV (3h). Reset by
 * WATCHDOG/REG_RST.
 */
typedef enum {
 ...
 * @note BQ25798_REG_NTC_CONTROL_0 (0x17), bits 4:3. POR: ICHG unchanged (3h). Reset by
 * WATCHDOG/REG_RST.
 */
typedef enum {
 ...
 * @note BQ25798_REG_NTC_CONTROL_0 (0x17), bits 2:1. POR: 20% of ICHG (1h). Reset by
 * WATCHDOG/REG_RST.
 */
typedef enum {
 ...
 * @note BQ25798_REG_NTC_CONTROL_1 (0x18), bits 7:6. POR: 68.4% / 10°C (1h). Reset by
 * WATCHDOG/REG_RST.
 *
 ...
 * @note BQ25798_REG_NTC_CONTROL_1 (0x18), bits 5:4. POR: 44.8% / 45°C (1h). Reset by
 * WATCHDOG/REG_RST.
 *
 * Values assume 103AT NTC thermistor with RT1=5.24 kΩ, RT2=30.31 kΩ.
 */
...
/** @brief OTG mode TS COLD threshold: 0=-10°C (default), 1=-20°C — bit 1 of
 * BQ25798_REG_NTC_CONTROL_1 (0x18). Reset by WATCHDOG/REG_RST. */
#define BQ25798_BCOLD_BIT (1u << 1)
/** @brief Ignore TS feedback (TS always reported good) — bit 0 of BQ25798_REG_NTC_CONTROL_1 (0x18).
 * POR: not ignored. Reset by WATCHDOG/REG_RST. */
